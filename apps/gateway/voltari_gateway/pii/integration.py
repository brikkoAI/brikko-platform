...
from voltari_gateway.pii.masker import PiiMapping, unmask_text
from voltari_gateway.pii.streaming import StreamUnmasker
...
def compute_pii_flags(
    *,
    ...
    """
    return bool(account_flag) or header_flag_truthy(header_value) or bool(body_flag)
...
def stream_unmask_chunk_openai(payload: dict[str, Any], unmasker: StreamUnmasker) -> None:
...
def stream_unmask_anthropic_event(payload: dict[str, Any], unmasker: StreamUnmasker) -> None:
